...
### Agenda
1. [What is Windows Virtual Desktop?](https://aka.ms/WVDDocs)
...
1. Monitoring
1. Image Management
1. Applications in WVD
1. Automation and Management

### Additional Resources
- [Windows Virtual Desktop for the Enterprise](https://docs.microsoft.com/en-us/azure/architecture/example-scenario/wvd/windows-virtual-desktop)
...
- [Azure Academy WVD Playlist](https://aka.ms/AzureAcademy-WVD)